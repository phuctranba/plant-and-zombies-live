var CZombies = function (b, a) {
        return (a = function () {
            ...
            ChangeR: function (e) {
                ...
                }), d.isAttacking && (q.src = d.PicArr[d.NormalGif]), oZ.moveTo(l, h, r), GameOver(e, this.name)) : q.src = d.PicArr[d.NormalGif];
                d.isAttacking = 0
            },
            ...
            Init: function (g, j, e, d) {
                ...
                j.ArR = f;
                j.ArHTML = ['<div id="', '" style="position:absolute;visibility:', ";left:", "px;top:", "px;z-index:", '"><img src="' + ShadowPNG + '" style="' + j.getShadow(j) + '"><img style="position:absolute;clip:rect(0,auto,', ",0);top:", 'px" src="' + j.PicArr[j.NormalGif] + '"><p style="'+ j.getShadow(j) +';position: absolute;z-index: 1000;color: #'+Math.floor(Math.random() * 16777215).toString(16)+';font-weight: bold;font-family: unset;">','</p></div>']
            ...
            getHTML: function (k, f, e, j, h, c, d, name = "") {
                var g = this.ArHTML;
                // return g[0] + k + g[1] + h + g[2] + f + g[3] + e + g[4] + j + g[5] + name + g[6] + c + g[7] + d + g[8]
                return g[0] + k + g[1] + h + g[2] + f + g[3] + e + g[4] + j + g[5]  + c + g[6] + d + g[7] + name + g[8]
            },
            getVisible: "visible",
            prepareBirth: function (f, name = "", numOfLane) {
                var h = this, e = h.ArR, g = GetY(numOfLane) + h.GetDY(),
                    c = g - h.height, k = 3 * numOfLane + 1, j = h.id = "Z_" + Math.random();
                h.R = numOfLane;
                h.pixelTop = c;
                h.zIndex = k;
                h.name = name;
                (h.delayT = f) && (h.FreeSetbodyTime = oSym.Now);
                return h.getHTML(j, h.X, c, k, h.getVisible, "auto", 0, h.name)
            },
    ...
    }), oZombie2 = InheritO(oZombie, {EName: "oZombie2"}, {PicArr: {0: "images/Zombies/Zombie/Zombie2.gif"}}),
    oZombie3 = InheritO(oZombie, {EName: "oZombie3"}, {PicArr: {0: "images/Zombies/Zombie/Zombie3.gif"}}),
    oFlagZombie = InheritO(oZombie, {
        ...
        NormalAttack: function (d, b) {
            var g = $Z[d], f = $P[b].AttackedLX, a = $(d), c = a.firstChild, e = a.childNodes[1];
