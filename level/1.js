            ...
            e < 755 ? oSym.addTask(3, arguments.callee, [e, g, a, d, c, f, b]) : (ClearChild($("SodRoll"), $("SodRollCap")), (function () {
                ...
                oP.Monitor({
                    ar: [0], f: function (k) {
                        ...
                        switch (k) {
                            case 0:
                                innerText($("DivTeach"), "Bấm vào lựa chọn hạt đậu！");
                                NewImg("PointerUD", "images/interface/PointerUP.gif", "top:60px;left:50px", EDAll);
                                oSym.addTask(10, arguments.callee, [++k]);
                                break;
                            case 1:
                                i > 0 && (innerText($("DivTeach"), "Nhấn chuột trồng cây bắn súng, trồng tốt nhất cánh bên trái！"), EditImg($("PointerUD"), "", "images/interface/PointerDown.gif", {
                                    left: "170px",
                                    top: "270px"
                                }), ++k);
                                oSym.addTask(10, arguments.callee, [k]);
                            ...
                            case 2:
                                ...
                                while (--l) {
                                    if (h["3_" + l + "_1"]) {
                                        SetNone($("PointerUD"));
                                        innerText($("DivTeach"), "Bấm vào thu thập ánh sáng rơi xuống！");
                                        AutoProduceSun(25);
                                        oSym.addTask(10, arguments.callee, [++k]);
                                        return
                                    }
                                ...
                                break;
                            case 3:
                                oS.SunNum > 99 && (innerText($("DivTeach"), "Bạn có đủ ánh sáng mặt trời đẻ phát triển！"), EditImg($("PointerUD"), "", "images/interface/PointerUP.gif", {
                                    left: "50px",
                                    top: "60px",
                                    display: "block"
                                }), ++k);
                            ...
                            default:
                                ...
                                j > 0 ? (SetNone($("PointerUD")), innerText($("DivTeach"), "Đừng để những con zombie đến gần ngôi nhà của bạn！"), oP.AddZombiesFlag(), oSym.addTask(500, SetNone, [$("DivTeach")])) : oSym.addTask(10, arguments.callee, [4])
                        }
                    }
                });
                BeginCool();
